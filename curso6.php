...
<head>
   ...
   <title>Curso de Peinados Social</title>
...
<body>
   ...
   <section id="info" class="wrap">
      <div id="imagen"><img src="img/c6.jpg" width="635px" height="506px"></div>
      <div id="detalle">
         <h2>CURSO DE PEINADOS SOCIAL</h2>
         <p>
            Este curso es ideal para complementar tus conocimientos como maquillador, asesor de imagen o productor de moda.
            Aprende a dominar técnicas profesionales de forma práctica y rápida.
            <br>
            La modalidad online y semipresencial te permite aprender a través de módulos, videos, demostraciones y prácticas dirigidas.
            Los videos son elaborados en alta calidad para que no te pierdas ningún detalle y los repitas las veces que desees.
            <br>
            Brindamos todos los conocimientos básicos y avanzados a través de clases en videos HD y trabajos prácticos para que puedas
            desarrollarte integralmente en la industria de la belleza
         </p>
      </div>
      ...
      <div id="datos">
         ...
         <div class="titulos nivel">
            ...
            <p class="ms-4">Básico - intermedio</p>
         </div>
         ...
         <div class="titulos fecha_inicio">
            ...
            <p class="ms-4">Septiembre 2021</p>
         </div>
         ...
         <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
               ...
               <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Tipos de cabellos</li>
                        <li>Presentación de productos y herramientas (usos y manejo)</li>
                        <li>Clase de Brushing (movimientos para obtener un cepillado perfecto)</li>
                        <li>Como manejar y rotar los cepillos</li>
                        <li>Uso de herramientas térmicas (plancha)</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Ondas clásicas</li>
                        <li>Ondas horizontales de agua sueltas y retro</li>
                        <li>Aplicación</li>
                     </ul>
                  </div>
               </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Trenza espiga</li>
                        <li>Trenza sobre puesta</li>
                        <li>Trenza clásica</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Técnicas para semirecogidos</li>
                        <li>Semirecogido aplicado a novias, quinceañeras</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingFive">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                     PRÁCTICAS PRESENCIALES DIRIGIDAS
                  </button>
               </h2>
