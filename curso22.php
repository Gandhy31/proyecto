...
$sql1 = "SELECT*
           FROM factura
           WHERE idUsuario='$id' AND idCurso=2";
...
<head>
   ...
   <title>Curso de Automaquillaje</title>
...
<body>
   ...
   <section id="info" class="wrap">
      <div id="imagen"><img src="img/c2.jpg" width="635px" height="506px"></div>
      <div id="detalle">
         <h2>CURSO DE AUTOMAQUILLAJE COMPLETO</h2>
         <p>En este curso conocerás la teoría fundamental del maquillaje y aprenderás a maquillarte con técnica profesional
            a través de clases en videos full HD, guías de apoyo y hojas de práctica.
            <br>
            Con este curso aprenderás a descubrir la mejor versión de tí. Es importante que sepas reconocer tu tipo de piel, rostro y rasgos morfólógicos para que puedas aplicar los productos correctos con la técnica correcta.
            <br>
            Este es un curso práctico que te permitirá, de manera rápida, obtener resultados profesionales en tu maquillaje.
         </p>
      </div>
      ...
      <div id="datos">
         ...
         <div class="titulos duracion">
            ...
            <p class="ms-4">3 horas intensivas</p>
         </div>
      ...
      <div id="acordeon">
         ...
         <ul class="list-group list-group-flush">
            <li class="list-group-item bg-ligth">RECONOCE TU TIPO DE PIEL</li>
            <li class="list-group-item bg-ligth">REOCNOCE TU TIPO DE ROSTRO</li>
            <li class="list-group-item bg-light">IDENTIFICA LOS PRODUCTOS QUE DEBES USAR Y LOS QUE NO DEBES UTILIZAR</li>
            <li class="list-group-item bg-light">CONOCE CÓMO UTILIZAR LA TEORÍA DEL COLOR PAR AQUE TU MAQUILLAJE TENGA ARMONÍA</li>
            <li class="list-group-item bg-light">APRENDE TÉCNICA DE MAQUILLAJE PROFESIONAL DE FORMA RÁPIDA Y PRÁCTICA</li>
            <li class="list-group-item bg-light">APRENDE UN LOOK DE DÍA Y CÓMO TRANSFORMAR ESTE EN UN MAQUILLAJE DE NOCHE</li>
         </ul>
      ...
      <a id="btn1" class="btn btn-success btn-lg mt-3 ms-auto
         ...
         ?>" href="compra.php?id=<?php echo $row['id'] ?>&idc=2" onClick="location.href: 'https://wa.me/593980264931?text=Me%20interesa%20el%20Curso%20de%20Maquillaje%20Profesional%20Online'" role="button" 
         <?php
            if ($cont == 1) {
