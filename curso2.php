   ...
   <section id="info" class="wrap">
      ...
      <div id="acordeon">
         ...
         <ul class="list-group list-group-flush">
            <li id="list-group" class="list-group-item bg-ligth">RECONOCE TU TIPO DE PIEL</li>
            <li id="list-group" class="list-group-item bg-ligth">REOCNOCE TU TIPO DE ROSTRO</li>
            <li id="list-group" class="list-group-item bg-light">IDENTIFICA LOS PRODUCTOS QUE DEBES USAR Y LOS QUE NO DEBES UTILIZAR</li>
            <li id="list-group" class="list-group-item bg-light">CONOCE CÓMO UTILIZAR LA TEORÍA DEL COLOR PAR AQUE TU MAQUILLAJE TENGA ARMONÍA</li>
            <li id="list-group" class="list-group-item bg-light">APRENDE TÉCNICA DE MAQUILLAJE PROFESIONAL DE FORMA RÁPIDA Y PRÁCTICA</li>
            <li id="list-group" class="list-group-item bg-light">APRENDE UN LOOK DE DÍA Y CÓMO TRANSFORMAR ESTE EN UN MAQUILLAJE DE NOCHE</li>
         </ul>
