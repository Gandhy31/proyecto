...
<body>
   ...
   <section id="info" class="wrap">
      <div id="imagen"><img src="img/c4.jpg" width="635px" height="600px"></div>
      <div id="detalle2">
         <h2>CURSO DE FOTOGRAFÍA INICIAL</h2>
         <p>
            En este curso aprenderás a manejar todas las funciones de tu cámara digital y llevarlas a la práctica para capturar fotografías de retrato urbano y belleza profesionales.
            <br>
            También aprenderás a revelar y editar tus fotografías con Photoshop.
            <br>
            La modalidad online te permite aprender a través de módulos, videos, demostraciones, tutorías por chat y tareas prácticas.
         </p>
      </div>
         ...
         <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
               ...
               <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>La fotografía</li>
                        <li>Historia de la fotografía</li>
                        <li>Elementos de la fotografía</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Tipos de objetivos y usos</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingFive">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                     EXPOSICIÓN (SENSIBILIDADISO, DIAFRAGMA Y OBTURACIÓN)
                  </button>
               </h2>
               <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Iso</li>
                        <li>Diafragma (profundidad de campo)</li>
                        <li>Obturador</li>
                        <li>Modos de medición de exposición</li>
                        <li>Matricial o evaluativo, central ponderado, puntual o spot.</li>
                        <li>Historgrama</li>
                        <li>Ajuste de blancos (temperatura de color), psicología del color</li>
                        <li>Enfoque (af/mf - tipos de enfoque)</li>
                        <li>Composición (reglas, planos)</li>
                        <li>Fotografía de retratno</li>
                        <li>Dirección y postura de modelo</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Luz dura vs suave</li>
                        <li>Luz principal, relleno</li>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Transferencia y almacenamiento</li>
                        <li>Revelado de fotografía</li>
                        <li>Retoque básico (imperfecciones, retirar objetos, color, máscaras)</li>
