...
<head>
   ...
   <title>Curso Técnica Especialista en Uñas</title>
...
<body>
   ...
   <section id="info" class="wrap">
      <div id="imagen"><img src="img/c3.png" width="635px" height="506px"></div>
      <div id="detalle">
         <h2>CURSO TÉCNICA ESPECIALISTA EN UÑAS</h2>
         <p>
            En este curso aprenderás las mejores técnicas y variedad de diseños para convertirte en una técnica especialista en uñas.
            <br>
            Iniciamos desde cero, no se necesitan conocimientos previos, solo muchas ganas de aprender.
            <br>
            Esta profesión es una de las que más demanda tienen y te permiten desarrollar tu propio negocio o trabajar en un centro de belleza inmediatamente.
         </p>
      </div>
      ...
      <div id="datos">
         ...
         <div class="titulos costo">
            ...
            <p class="ms-4">Mensual <?php echo "$ " . $row2['precio'] ?></p>
         </div>
         ...
         <div class="titulos fecha_inicio">
            ...
            <p class="ms-4">
               Miércoles de 09h00 a 12h00
               <br>
               Domingos de 09h30 a 12h30
            </p>
         </div>
         ...
         <div class="titulos certificado">
            ...
            <p class="ms-4">Las personas que culminen satisfactoriamente el curso recibirán un certificado avalado por
               la escuela Inua y la Asociación Interprofesional de Artesanos</p>
         </div>
         ...
         <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
               ...
               <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Anatomía de la uña</li>
                        <li>Cuidados y patologías de la uña</li>
                        <li>Técnicas de bioseguridad</li>
                        <li>Protocolos de servicio</li>
                        <li>Manicura rusa y manejo de drill</li>
                        <li>Puntas vanguardistas</li>
                        <li>Técnicas de limado y tipos de limas</li>
                        <li>Estructura</li>
                        <li>Acrílico nivel 1</li>
                        <li>Gel y acrigel nivel 1</li>
                        <li>3D nivel 1 y 2</li>
                        <li>Baby Boomer y técnica ombré</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Esculpido</li>
                        <li>Polygel nivel 1 y 2</li>
                        <li>Esmaltado semipermanente</li>
                        <li>Técnica navaja</li>
                        <li>Técnica efecto marmol</li>
                        <li>Degradé de colores</li>
                        <li>Encapsulado con flores o naturaleza muerta</li>
                        <li>Efecto sugar</li>
                     </ul>
                  </div>
               </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Painting gel efecto jersey</li>
                        <li>Painting gel efecto arcoiris</li>
                        <li>Blooming gel y ojo de gato</li>
                        <li>Efecto espejo, unicornio aurora y holográfico</li>
                        <li>Spider gel, cola de sirena y efecto foil</li>
                        <li>Diseño de pigmento y colorimetría</li>
                        <li>Stamping uñas mágicas y efecto repujado</li>
                        <li>Diseño de flores gel plastilina 4D</li>
                     </ul>
                  </div>
               </div>
            </div>
