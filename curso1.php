...
<body>
            ...
            <div class="container-fluid">
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                  ...
                  <ul class="navbar-nav ms-auto">
                     ...
                     <li class="nav-item"><a class="nav-link active " aria-current="page" href="registro.php">Registrarse</a></li>
                  </ul>
   ...
   <section id="info" class="wrap">
      <div id="imagen"><img src="img/c1.jpg"></div>
      <div id="detalle">
         <h2>CURSO DE MAQUILLAJE PROFESIONAL ONLINE</h2>
         <p>Estudia tu carrera de Maquillaje Profesional en la modalidad online y aprende a través de módulos, videos,
            demostraciones y prácticas dirigidas. Brindamos todos los conocimientos básicos y avanzados para que puedas
            desarrollarte en la industria del maquillaje profesional. <br>

            Nuestro curso online tiene el mismo contenido que el curso presencial con el propósito de asegurarnos que
            todos nuestros estudiantes adquieran el mismo nivel de educación.
         </p>
      </div>
      ...
      <div id="datos">
         ...
         <div class="titulos duracion">
            ...
            <p class="ms-4">3 meses intensivos. <br> Completa 2 módulos semanales para poder avanzar con las siguientes
               clases de tu curso.</p>
         </div>
         ...
         <div class="titulos fecha_inicio">
            ...
            <p class="ms-4">26 de Octubre 2021</p>
         </div>
         ...
         <div class="titulos certificado">
            ...
            <p class="ms-4">Las personas que culminen satisfactoriamente el curso recibirán un certificado avalado por
               la escuela Inua y por el Ministerio de Trabajo.</p>
         </div>
         ...
         <div class="accordion" id="accordionExample">
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingOne">
                  <button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                     INICIACIÓN AL MAQUILLAJE PROFESIONAL
                  </button>
               </h2>
               <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Fundamentos del maquillaje</li>
                        <li>Normas del maquillador</li>
                        <li>Lenguaje técnico</li>
                        <li>Herramientas del maquillador</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Anatomía y patologías de la piel</li>
                        <li>Tipos de piel</li>
                        <li>Preparación de piel</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingThree">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                     CORRECCIONES CROMÁTICAS Y MOFOLÓGICAS
                  </button>
               </h2>
               <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Visagismo</li>
                        <li>Correctores</li>
                        <li>Bases y primers</li>
                        <li>Iluminación y contornos</li>
                        <li>Teoría del calor</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingFour">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                     TÉCNICAS DE MAQUILLAJE 1
                  </button>
               </h2>
               <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Partes del ojo</li>
                        <li>Diseño de cejas</li>
                        <li>Protocolos del maquillaje</li>
                        <li>Maquillaje nude/soft</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               ...
               <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Delineados</li>
                        <li>Maquillaje pin up</li>
                        <li>Maquillaje para piel madura</li>
                        <li>Maquillaje para reina</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingSix">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                     TÉCNICAS DE MAQUILLAJE 3
                  </button>
               </h2>
               <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Maquillaje para quinceañera</li>
                        <li>Maquillaje de novia glam clásica</li>
                        <li>Maquillaje de novia glam hd</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingSeven">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                     TÉCNICAS DE MAQUILLAJE 4
                  </button>
               </h2>
               <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Maquillaje para piel morena</li>
                        <li>Maquillaje editorial/artistico</li>
                        <li>Proyecto maquillaje editorial</li>
            ...
            <div class="accordion-item">
               <h2 class="accordion-header" id="headingEight">
                  <button class="accordion-button collapsed bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                     MODELO DE NEGOCIO
                  </button>
               </h2>
               <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                     <ul>
                        <li>Definición de segmento</li>
                        <li>Preposición de valor</li>
